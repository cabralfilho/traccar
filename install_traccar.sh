#!/bin/bash
# Version: 1.0.0
# Desenvolvido por fabiano cabral
# Suporte por email cabralfilhodj@gmail.com 
...
echo
echo -en " Instalando MySQL , aguarde ...................";ProgressBar; echo -e " [\033[0;32m ok\033[m ]"
#echo "Instalando MySQL  Aguarde..."
echo "mysql-server mysql-server/root_password password root" | sudo debconf-set-selections
echo "mysql-server mysql-server/root_password_again password root" | sudo debconf-set-selections
apt-get -y install mysql-server mysql-client >> $ARQLOG 2>&1
...
MYSQL_SCRIPT
echo
echo " Instalando Traccar 4.10"
cd $USERHOME
wget https://github.com/traccar/traccar/releases/download/v4.10/traccar-linux-64-4.10.zip >> $ARQLOG 2>&1
